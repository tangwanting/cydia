...
if (window.innerWidth === 375) {
    ...
    document.querySelector("meta[name=viewport]").setAttribute('content', 'width=device-width, initial-scale=1.222, maximum-scale=1.222, user-scalable=0');
}else if(window.innerWidth === 428){
    document.querySelector("meta[name=viewport]").setAttribute('content', 'width=device-width, initial-scale=1.3444, maximum-scale=1.3444, user-scalable=0');
