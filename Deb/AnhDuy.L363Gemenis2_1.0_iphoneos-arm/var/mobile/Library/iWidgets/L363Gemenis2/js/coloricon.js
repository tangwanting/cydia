...
function getIconInfo(number, info) {
    var hours = new Date().getHours(),
        isDayTime = hours > 6 && hours < 20;
    if (iconInfo[number]) {
        if (number == 26 && !isDayTime) {
            if (info === 'color') {
                return 'light';
            } else if (info === 'imageName') {
                return 'sunnynight';
            } else {
                return iconInfo[number][info];
            }
        } else {
            return iconInfo[number][info];
        }
                ...
                d = function() {
                    function d(b) {
                        ...
                        return b.circleProgress ? b.circleProgress : (b.circleProgress = this, this.doc = e, b.setAttribute("role", "progressbar"), this.el = b, c = _extends({}, d.defaults, c), Object.defineProperty(this, "_attrs", {
                            ...
                            paper: a(b, 100, 100),
                            angle: 0
                        }, this.graph.paper.svg.setAttribute("class", "circle-progress-" + b.className), this.graph.circle = this.graph.paper.element("circle").attr({
                            "class": "circle-progress-circle" + b.className,
                            cx: 50,
                            cy: 50,
                            r: 50 - f / 2,
                            fill: "none",
                            ...
                            "class": "circle-progress-value" + b.className,
                            fill: "none",
                            stroke: "#00E699",
                            "stroke-width": f
                        }), this.graph.text = this.graph.paper.element("text", {
                            "class": "circle-progress-text" + b.class,
                            x: 50,
                            y: 50,
